...
class Scene
{
	 ...
	 * @param $themeId
	 * @return string
	 * Set specific scene, returns all set light states from individual lamps.
	...
	public function setTheme($themeId)
	{
		...
		//echo "\n\nStarting Scene:'" . $this->data[$themeId]['name'] . "'\n";
	...
	private function checkThemes()
	{
		...
		if ($this->data == null) {
			$this->data = array(
    			1 =>  array(
	    			"name" => "Example Scene: Study on, bathroom off",
	    			"lightstates" => array(
	    				array(
	    		...
	    		2 => array(
	    			"name" => "Example Scene 2: Bathroom red",
	    			"lightstates" => array(
	    				array(
	    					"bridge" => "BridgeHue",
	    		...
	    		3 => array(
	    			"name" => "Example Scene 3: 3 hues off",
	    			"lightstates" => array(
	    				array(
	    					"bridge" => "BridgeHue",
	    					"name" => "Lamp Badkamer uit",
	    		...
	    		4 => array(
	    			"name" => "Example Scene 3: 3 hues on",
	    			"lightstates" => array(
	    				array(
	    					"bridge" => "BridgeHue",
